...
HD_PWD='C:/Users/Jonathan/Desktop/proj2/hello_world/helloWorld/helloWorld.runs/hello_block_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_block_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_block_axi_timer_0_0.tcl
