...
HD_PWD='C:/Users/Jonathan/Desktop/proj2/hello_world/helloWorld/helloWorld.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_block_wrapper.tcl
