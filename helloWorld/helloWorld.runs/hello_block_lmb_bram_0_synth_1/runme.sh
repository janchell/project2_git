...
HD_PWD='C:/Users/Jonathan/Desktop/proj2/hello_world/helloWorld/helloWorld.runs/hello_block_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_block_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_block_lmb_bram_0.tcl
