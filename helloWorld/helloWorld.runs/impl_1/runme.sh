...
HD_PWD='C:/Users/Jonathan/Desktop/proj2/hello_world/helloWorld/helloWorld.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello_block_wrapper.tcl -notrace
