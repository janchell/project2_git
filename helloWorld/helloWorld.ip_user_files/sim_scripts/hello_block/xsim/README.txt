...
#
# Generated by export_simulation on Wed May 02 16:16:05 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './hello_block.sh' script.

./hello_block.sh -reset_run
...
./hello_block.sh -noclean_files

For more information on the script, please type './hello_block.sh -help'.
