...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.hello_block \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../helloWorld.srcs/sources_1/bd/hello_block/ipshared/4868" \
       +incdir+"$ref_dir/../../../../helloWorld.srcs/sources_1/bd/hello_block/ipshared/ec67/hdl" \
       +incdir+"../../../../helloWorld.srcs/sources_1/bd/hello_block/ipshared/4868" \
       +incdir+"../../../../helloWorld.srcs/sources_1/bd/hello_block/ipshared/ec67/hdl"
}
